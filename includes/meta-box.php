...
/*
Ancien modèle fonction learndash_notifications_get_shortcodes_instructions

user_shortcode
[ld_notifications field="user" show="username"] : Afficher l’identifiant de l’utilisateur.
[ld_notifications field="user" show="email"] : Afficher l'e-mail de l'utilisateur.
[ld_notifications field="user" show="display_name"] : Afficher le nom d’affichage de l'utilisateur.
[ld_notifications field="user" show="first_name"] : Afficher le prénom de l'utilisateur.
[ld_notifications field="user" show="last_name"] : Afficher le nom de l'utilisateur.

group_basic_shortcode
[ld_notifications field="group" show="title"] : Afficher le titre du groupe.

course_basic_shortcode
[learnx_notifications field="course" show="title"] : Afficher le titre de la formation.
[learnx_notifications field="course" show="url"] : Afficher l'URL de la formation.

course_advanced_shortcode
[learnx_notifications field="course" show="completed_on" format=""] : Affichage du temps lorsque le cours est terminé. Cliquez ici pour voir les options de format.
[learnx_notifications field="course" show="cumulative_score"] : Afficher la moyenne des points de score sur tous les quiz d'une formation.
[learnx_notifications field="course" show="cumulative_points"] : Afficher la moyenne des points sur tous les quiz d'une formation.
[learnx_notifications field="course" show="cumulative_total_points"] : Afficher le total de moyenne des points sur tous les quiz d'une formation.
[learnx_notifications field="course" show="cumulative_percentage"] : Afficher le pourcentage de moyenne des réponses correctes sur tous les quiz d'une formation.
[learnx_notifications field="course" show="cumulative_timespent"] : Afficher le temps moyen passé sur tous les quiz d'une formation.
[learnx_notifications field="course" show="cumulative_count"] : Afficher la moyenne de réponse correcte comptée sur tous les quiz d'une formation.
[learnx_notifications field="course" show="aggregate_percentage"] : Afficher le pourcentage de somme des réponses correctes sur tous les quiz de la formation.
[learnx_notifications field="course" show="aggregate_score"] : Afficher la somme des points marqués sur tous les quiz de la formation.
[learnx_notifications field="course" show="aggregate_points"] : Afficher la somme des points obtenus sur tous les quiz de la formation.
[learnx_notifications field="course" show="aggregate_total_points"] : Afficher la somme des points totaux sur tous les quiz de la formation.
[learnx_notifications field="course" show="aggregate_timespent"] : Afficher la somme du temps passé sur tous les quiz de la formation.
[learnx_notifications field="course" show="aggregate_count"] : Afficher la somme de réponse correcte compté sur tous les quiz de la formation.

lesson_shortcode
[learnx_notifications field="lesson" show="title"] : Afficher le titre du module.
[learnx_notifications field="lesson" show="url"] : Afficher l'URL du module.

topic_shortcode
[learnx_notifications field="topic" show="title"] : Afficher le titre de l'étape.
[learnx_notifications field="topic" show="url"] : Afficher l'URL de l'étape.

quiz_shortcode
[learnx_notifications field="quiz" show="url"] : Afficher l'URL du quiz.
[learnx_notifications field="quiz" show="timestamp" format=""] : Affichage du temps quand le quiz est pris. Cliqure ici pour voir les options de format.
[learnx_notifications field="quiz" show="percentage"] : Afficher le pourcentage correct du quiz.
[learnx_notifications field="quiz" show="pass"] : Afficher si l'utilisateur passe le quiz ou non. Affiche "Oui" ou "Non".
[learnx_notifications field="quiz" show="quiz_title"] : Afficher le titre du quiz.
[learnx_notifications field="quiz" show="course_title"] : Afficher le titre de la formation auquel le quiz appartient. 
[learnx_notifications field="quiz" show="timespent"] : Afficher le temps passé pour terminer le quiz.
[learnx_notifications field="quiz" show="categories"] : Afficher le résultat du quiz en fonction des catégories.

essay_shortcode
[learnx_notifications field="essay" show="points_earned"] : Afficher le total des points gagnés.
[learnx_notifications field="essay" show="points_total"] : Afficher le total des points possibles par tentative.

assignment_shortcode
[learnx_notifications field="assignment" show="title"] : Afficher le titre du devoir.
[learnx_notifications field="assignment" show="file_name"] : Afficher le nom du fichier du devoir.
[learnx_notifications field="assignment" show="file_link"] : Afficher le lien du fichier du devoir.
[learnx_notifications field="assignment" show="lesson_title"] : Afficher le titre du module à laquelle appartient le devoir.
[learnx_notifications field="assignment" show="lesson_type"] : Afficher le type du module auquel le devoir appartient.
*/

function learndash_notifications_get_shortcodes_instructions(){
	$user_shortcode = array(
		'[learnx_notifications affiche="Identifiant"]' => __( 'Display user\'s username.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Email"]' => __( 'Display user\'s email.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Nom_Affichage_Utilisateur"]' => __( 'Display user\'s display name.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Prénom_Utilisateur"]' => __( 'Display user\'s first name.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Nom_Utilisateur"]' => __( 'Display user\'s last name.', 'learndash-notifications' ),
	);

	$group_basic_shortcode = array(
		'[learnx_notifications affiche="Titre_Groupe"]' => __( 'Display group title.', 'learndash-notifications' ),
	);

	$course_basic_shortcode = array(
		'[learnx_notifications affiche="Titre_Formation"]' => __( 'Display course title.', 'learndash-notifications' ),
		'[learnx_notifications affiche="URL_Formation"]' => __( 'Display course URL.', 'learndash-notifications' ),
	);

	$course_advanced_shortcode = array(
		'[learnx_notifications affiche="Temps_Formation_Terminer"]' => __( 'Display time when course is completed. <a href="http://php.net/manual/en/function.date.php" target="_blank">Click here</a> to see format options.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Moyenne_Score_Quiz"]' => __( 'Display average points scored across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Moyenne_Points_Quiz"]' => __( 'Display average points got across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Total_Moyenne_Points_Quiz"]' => __( 'Display average total points got across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Pourcentage_Moyenne_Bonnes_Reponses_Quiz"]' => __( 'Display average correct answers percentage across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Temps_Moyen_Passé_Quiz"]' => __( 'Display average time spent across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Moyenne_Bonnes_Réponses_Comptés_Quiz"]' => __( 'Display average correct answer counted across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Pourcentage_Somme_Bonnes_Réponses_Quiz"]' => __( 'Display sum of correct answers percentage across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Somme_Points_Marqués_Quiz"]' => __( 'Display sum of points scored across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Somme_Points_Obtenus_Quiz"]' => __( 'Display sum of points got across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Somme_Points_Totaux_Quiz"]' => __( 'Display sum of total points got across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Somme_Temps_Passé_Quiz"]' => __( 'Display sum of time spent across all quizzes on the course.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Somme_Bonnes_Réponses_Comptés_Quiz"]' => __( 'Display sum of correct answer counted across all quizzes on the course.', 'learndash-notifications' ),
	);

	$lesson_shortcode = array(
		'[learnx_notifications affiche="Titre_Module"]' => __( 'Display lesson title.', 'learndash-notifications' ),
		'[learnx_notifications affiche="URL_Module"]' => __( 'Display lesson URL.', 'learndash-notifications' ),
	);

	$topic_shortcode = array(
		'[learnx_notifications affiche="Titre_Etape"]' => __( 'Display topic title.', 'learndash-notifications' ),
		'[learnx_notifications affiche="URL_Etape"]' => __( 'Display topic URL.', 'learndash-notifications' ),
	);

	$quiz_shortcode = array(
		'[learnx_notifications affiche="URL_Quiz"]' => __( 'Display quiz URL.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Temps_Quiz"]' => __( 'Display time when the quiz is taken. <a href="http://php.net/manual/en/function.date.php" target="_blank">Click here</a> to see format options.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Pourcentage_Correcte_Quiz"]' => __( 'Display correct percentage of the quiz.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Autorisation_Passage_Quiz"]' => __( 'Display whether the user passes the quiz or not. Display "Yes" or "No".', 'learndash-notifications' ),
		'[learnx_notifications affiche="Titre_Quiz"]' => __( 'Display quiz title.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Titre_Formation_Quiz"]' => __( 'Display course title that quiz belongs to.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Temps_Passé_Quiz"]' => __( 'Display how long is taken to complete the quiz.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Résultat_Catégories_Quiz"]' => __( 'Display quiz result based on categories.', 'learndash-notifications' ),
	);

	$essay_shortcode = array(
		'[learnx_notifications affiche="Total_Points_Gagnés"]' => __( 'Display total points earned.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Total_Points_Possible"]' => __( 'Display total points possible for the essay.', 'learndash-notifications' ),
	);

	$assignment_shortcode = array(
		'[learnx_notifications affiche="Titre_Devoir"]' => __( 'Display assignment title.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Nom_Fichier_Devoir"]' => __( 'Display assignment file name.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Lien_Fichier_Devoir"]' => __( 'Display assignment file link.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Titre_Module_Devoir"]' => __( 'Display lesson title that the assignment belongs to.', 'learndash-notifications' ),
		'[learnx_notifications affiche="Type_Module_Devoir"]' => __( 'Display lesson type that the assignment belongs to.', 'learndash-notifications' ),
	);
